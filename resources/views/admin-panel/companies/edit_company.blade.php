            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form id="form1" novalidate method="POST" action="{{ url('update-company/' . $data->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" data-inputmask="'mask': '0399-99999999'" required type="number"
                                        ...
                                        name="phone" value="{{ $data->phone }}" autocomplete="phone" autofocus>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" id="ntn_no"
                                        ...
                                        value="{{ $data->ntn_no }}" required autocomplete="ntn_no" autofocus>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" id="web_url" name="web_url" required
                                        ...
                                        value="{{ $data->web_url }}" required autocomplete="web_url" autofocus>
