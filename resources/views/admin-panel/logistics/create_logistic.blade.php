                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (isset($data))
                            {{-- @dd($data); --}}
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100 table-sm table-responsive ">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Company Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->logistic_company->name }}</td>
                                        ...
                                        <td style="width: 100px">
                                            <a href="{{ url('print-parcel/' . $item->id) }}" class="btn btn-outline-dark btn-sm print" title="Print">
