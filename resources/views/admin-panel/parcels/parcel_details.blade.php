                            ...
                            <div class="card-body px-3 py-0">
                                    ...
                                    <div class="mb-0">
                                        <div class="row">
                                            <div class="col  text-center">
                                                <img src="{{ asset('assets/images/LogoBFS.png') }}" alt="logo"
                                                    height="60" covered />
                                            </div>
                                            <div class="col">
                                ...
                                <div class="page-title-right">
                                    ...
                                    <ol class="breadcrumb m-0 text-bold text-decoration-underline">
                                        <li class="breadcrumb-item">Tracking ID: <span
                                                class="text-bold">{{ $data->pl_id }}</span></li>
                                        <li class="breadcrumb-item  text-bold">Service Used: <span
                                                class="text-bold text-primary">{{ $data->parcel_with_service->service_name }}</span>
                                        </li>
                                        <li class="breadcrumb-item  text-bold">Destination: <span
                                                class="text-bold text-primary">{{ $data->parcel_with_consignee->consignee_with_country->name }}</span>
                                        </li>
                                        <li class="breadcrumb-item  text-bold">Status: <span
                                                class="text-bold text-danger">{{ $data->pl_status }}</span></li>
                                        <li class="breadcrumb-item  text-bold">Dated: <span
                                                class="text-bold">{{ date('d,m,Y', strtotime($data->created_at)) }}</span>
                                        </li>
                                    </ol>
                                </div>
                                <div class=" ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_payment->payment_method }}</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-sm  table-responsive-sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_name }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_phone }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_business }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_with_country->name }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_state }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_city }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_state }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_state }}</td>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_address1 }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_consignee->consignee_address2 }}</td>
                                                </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-sm  table-responsive-sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->company_name }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_phone }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->company_name }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_with_country->name }}</td>
                                                </tr>
                                                <tr>
                                                    <th class="py-1 px-0 font-size-14" scope="col">State</th>
                                                    <th class="py-1 px-0 font-size-14" scope="col">City</th>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_state }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_city }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_zip }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_zip }}</td>
                                                ...
                                                <tr>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_address1 }}</td>
                                                    <td class="py-1 px-0 font-size-14">
                                                        {{ $data->parcel_with_shipper->shipper_address2 }}</td>
                                ...
                                <div class="d-print-none">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex justify-content-between"> <a href="{{ route('home') }}"
                                            ...
                                            <a href="{{ route('home') }}"
                                                class="btn btn-dark btn-md text-white btn-sm m-2 px-2">Dashboard </a>
                                        </div>
                                        {{-- <a href="{{url('edit-parcel')}}">Edit Parcel</a>
                                    <a href="{{url('delete-parcel')}}">Delete Parcel</a> --}}
                                        <a href="javascript:window.print()"
                                            class="btn btn-success waves-effect waves-light  mr-4 pt-2 pb-0 px-3 mb-1"><i
