                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('/') }}">Invoices</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="invoice-title">
                                    <h4 class="float-end font-size-16">Region-Country Details</h4>
                                    <div class="mb-4">
                                ...
                                <div class="py-2 mt-3">
                                    <h3 class="font-size-15 fw-bold">Countries with Regions Summary</h3>
                                </div>
