...
<div class="container">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <a class="btn btn-info btn-md text-white font-size-12 p-2"
                                                    ...
                                                    data-bs-target="#customer-payment-modal">Add
                                                    Customer's Payment</a>
                                                <a href="#"
                        ...
                        <div class="card px-0">
                            <div class="card-body bg-light border rounded px-0">
                                <div class="modal-header mb-2" style="background-color: #d6dbf8">
                                    ...
                                    <a class="btn-close" data-toggle="collapse" href="#balancesheettable"
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="vendor-payment-form" action="{{ url('vendor-payment-add') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="vendor-payment-form"
                                class="btn btn-primary vendor-tracking-id" id="modal_submit13"
    ...
    <div class="modal fade" id="customer-payment-modal" aria-hidden="true" aria-labelledby="..." tabindex="-1">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" id="customer-payment-form" action="{{ url('customer-payment-add') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="">Enter Amount</label>
                                    <input type="text" name="collected_amount" value=""
                                        id="collected_amount" class="form-control">
                                </div>
                            </div>
        ...
        <div class="modal fade" id="customer-payment-modal" aria-hidden="true" aria-labelledby="..."
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #d6dbf8">
