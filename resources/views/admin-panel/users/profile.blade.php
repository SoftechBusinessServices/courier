...
@section('content')
    ...
    <!-- Update profile -->
    <div class="modal fade edit-profile-modal" tabindex="-1" role="dialog"
        aria-labelledby="transaction-detailModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="change-password-modal-label">Edit User Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <table class="table align-middle table-nowrap">
                            ...
                            <tbody>
                                <form id="change-password-form" class="form-horizontal" method="POST"
                                    action="{{ url('update-profile/' . $data->id) }}">
                                    @csrf
                                    <div class="container">
                                        <div class="row">
                                    ...
                                    <div class="col-md-11 mb-3 offset-1 ">
                                        <button type="submit" form="change-password-form" class="btn btn-primary "
                                            id="modal_submit_password" value="Submit"> Update Record</button>
                                        <button type="button" class="btn btn-secondary" id="modal_close_password"
                                            data-bs-dismiss="modal">Close</button>
                                    </div>
                                </form>
                            </tbody>
